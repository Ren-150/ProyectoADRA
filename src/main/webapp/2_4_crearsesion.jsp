						...
						<div class="col-12">
							<div id="todo">
								<div class="formulario">
									<div class="header">REGISTRO DE SESIONES</div>
									<div class="cuerpo">
										...
										<div class="form-group row">
											<label for="" class="col-sm-3 col-form-label">Objetivo:</label>
											<div class="col-sm-8">
										...
										<div class="form-group row">
											<label for="" class="col-sm-3 col-form-label">Capacitacion:</label>
											<div class="col-sm-8">
